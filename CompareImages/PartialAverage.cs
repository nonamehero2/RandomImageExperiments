...
namespace CompareImages
{
    ...
    {
        public PartialAverage(Bitmap image1, Bitmap image2)
        {
            bitmap01 = image1;
            bitmap02 = image2;
        }
        ...
        public void writeBitmap(string imagePath)
        {
            ...
            {
                Console.WriteLine("PartialAverage Bitmap Start");
                for (int x = 0; x < data1rgbValues.Length; x++)
                {
                    if (x % 4 != 3)
                    {
                        data1rgbValues[x] = (byte)(data1rgbValues[x] + data2rgbValues[x] + 1);
                        data1rgbValues[x] = (byte)(data1rgbValues[x] % 255);
                    }
                }
            }
            ...
            Console.WriteLine("PartialAverage Bitmap Writing");
